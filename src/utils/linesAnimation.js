...
const linesAnimation = () => {
  ...
  // for services
  let allServicesHorizontalBorder = document.querySelectorAll(
  ...
  // services accordion
  let allServicesAccordion = document.querySelectorAll(
  ...
  // services accordion
  let allServicesAccordionItem = document.querySelectorAll(
