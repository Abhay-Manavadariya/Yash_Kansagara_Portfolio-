...
const personal_content: DataType = {
  ...
  title: "Can't wait to dive into the project and brainstorm ideas together!",
...
const PersonalInfo = () => {
  return (
    <>
      <div className="ab-personal-info__area theme-bg-2 pb-30 tp-personal-info-pin-section">
          ...
          <div className="row">
            <div className="col-xl-6 col-lg-6">
              <div className="tp-personal-info-pin">
                <div className="ab-personal-info__left-box mr-200">
                  <div
                    className="tp-services-wrapper tp-services-capsule-wrapper p-relative"
                      ...
                      <h4 className="ab-personal-info__left-content-title">
                        <span>
                          ...
                          >
                            ...
                            />
                            <path
                              d="M27.9982 26.8334H13.3506V28H27.9982V26.8334Z"
                              fill="currentcolor"
                            />
                          </svg>
                        </span>
            ...
            <div className="col-xl-6 col-lg-6">
              <div className="ab-personal-info__right-wrap">
                <div
                  className="ab-personal-info__skill mb-85 wow tpfadeRight"
                ...
                <div
                  className="ab-personal-info__exprience mb-85 wow tpfadeLeft"
                  data-wow-duration=".9s"
                  data-wow-delay=".5s"
                >
                  <h4 className="ab-personal-info__right-title">
                  ...
                  {experience_data.map((item, index) => (
                    ...
                    >
                      ...
                      <div className="ab-personal-info__exprience-content">
                        <h4 className="ab-personal-info__exprience-title">
                          {item.designation}
                        </h4>
                      </div>
                    </div>
                ...
                {/* <div
                  className="ab-personal-info__exprience mb-85 wow tpfadeRight"
                  data-wow-duration=".9s"
                  data-wow-delay=".7s"
                >
                  <h4 className="ab-personal-info__right-title">
