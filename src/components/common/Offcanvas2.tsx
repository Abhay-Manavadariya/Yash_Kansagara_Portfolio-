...
const Offcanvas2 = ({ showCanvas, setShowCanvas }: any) => {
  return (
    <>
      <div
        className={`tp-offcanvas-area-2 tp-menu-2 ${
          showCanvas ? "opened" : ""
        }`}
      >
        ...
        <div className="tp-offcanvas-wrapper">
          <div className="tp-offcanvas-top-2 d-flex align-items-center justify-content-between">
            ...
            <div className="tp-offcanvas-close-2">
              <button
                className="tp-offcanvas-close-btn-2 tp-offcanvas-open-btn-2"
          ...
          <div className="tp-offcanvas-main-2">
            <div className="tp-offcanvas-content-2">
              ...
              <p>I'm Mr.Zenzee.</p>
              <p>One Stop Shop For All Your Digital Needs.</p>
            </div>
              ...
              <div className="row gx-2">
                <div className="col-md-3 col-3">
                  <div className="tp-offcanvas-gallery-img fix">
                    <a href="#">
                      <Image src={offcanvas_1} alt="image" />
                    </a>
                  </div>
                </div>
                <div className="col-md-3 col-3">
                  <div className="tp-offcanvas-gallery-img fix">
                    <a href="#">
                      <Image src={offcanvas_2} alt="image" />
                    </a>
                  </div>
                </div>
                <div className="col-md-3 col-3">
                  <div className="tp-offcanvas-gallery-img fix">
                    <a href="#">
                      <Image src={offcanvas_3} alt="image" />
                    </a>
                  </div>
                </div>
                <div className="col-md-3 col-3">
            ...
            <div className="tp-offcanvas-contact-2">
              ...
              <ul>
                <li>
                  <a href="https://mail.google.com/mail/?view=cm&fs=1&to=mr.zenzee8@gmail.com">
                    mr.zenzee8@gmail.com
                  </a>
                </li>
                <li>
                  <a href="#">
                    303-RK Empire, 150 Feet Ring Road, Near Mavdi Circle,
                    Rajkot, Gujrat - 3620004, India.
                  </a>
                </li>
              </ul>
            </div>
