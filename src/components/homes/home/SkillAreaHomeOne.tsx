...
import skill_img_13 from "@/assets/img/skill/ae-sm.png";
                  ...
                  >
                    {skill_data.map((item, i) => (
                      <button
                        ...
                        id={`nav-${item.tab_id}-tab`}
                        data-bs-toggle="tab"
                        data-bs-target={`#nav-${item.tab_id}`}
                        type="button"
                        role="tab"
                        aria-controls={`nav-${item.tab_id}`}
                    ...
                    <div className="tp-skill-tab-content tp-skill-radius">
                      ...
                      >
                        {item.items.map((inner_item, index) => (
                          <div
                            key={index}
                            className="col-xl-2 col-lg-3 col-md-3 col-6"
                          >
