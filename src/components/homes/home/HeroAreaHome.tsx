...
const hero_content: DataType = {
  slide_text: ["Visual designer", "Visual designer"],
  sub_title: "Hello There!",
  title_1: "I am Mr.Zenzee",
  words: ["Logo", "Branding", "UI/UX", "Web"],
  title_2: "designer",
  sm_info: <>One Stop Shop For All Your Digital Needs.</>,
  btn_text: (
    <>
      Get <br /> In Touch
    </>
...
const { slide_text, sub_title, title_1, words, title_2, sm_info, btn_text } =
  hero_content;
    ...
    <>
      <section className="tp-hero-area p-relative tp-btn-trigger z-index-1 fix theme-bg-2">
        ...
        <div className="tp-hero-shape">
          <div
            className="tp-hero-shape-1 background-white-mode"
            style={{
              backgroundImage: "url(/assets/img/hero/hero-overlay.png)",
            }}
          ></div>
          <div
            className="tp-hero-shape-1 background-dark-mode"
            style={{
              backgroundImage: "url(/assets/img/hero/hero-overlay-2.png)",
            }}
          ></div>
        ...
        <div className="tp-hero-bottom-text-wrapper">
          <div className="tp-hero-bottom-text">
            {slide_text.map((item, index) => (
              <p style={{ opacity: "0.15" }} key={index}>
                {item}
              </p>
            ))}
          </div>
              ...
              <div className="tp-hero-left-wrapper">
                <div className="tp-hero-content tp_text_anim p-relative z-index-1">
                  <span className="singleLine">
                    {sub_title} <Image src={HeroHand} alt="diego-image" />
                  </span>
                    ...
                    <span className="cd-words-wrapper">
                      {words.map((word, index) => (
                        <b
                          key={index}
                          className={`${
                            index === currentWord ? "is-visible" : "is-hidden"
                          }`}
                        >
                          {word}
                        </b>
                  ...
                  <p style={{ paddingLeft: "0%", fontSize: "2.188rem" }}>
                    {sm_info}
                  </p>
                  <div className="tp-hero-btn wrap">
                    <div className="tp-hover-btn-wrapper tp-btn-bounce">
                      <Link
                        href="/contact"
                        className="tp-hover-btn tp-hover-btn-item tp-btn-circle square"
                      >
                        <span className="tp-btn-circle-text">{btn_text}</span>
