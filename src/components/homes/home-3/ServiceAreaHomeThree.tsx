...
const service_content: DataType = {
  ...
  title: (
    <>
      How We <br /> Carry Out Our Projects
    </>
  ),
  sm_info: (
    <>
      We offer a range of services to help elevate <br /> your brand & drive
      results.
    </>
  ),
  btn_text: (
  ...
  service_data: [
    {
      ...
      sm_des: (
        <>
          We always ensure that it combines a clean <br /> and beautiful visual
          design.
        </>
      ),
      tag_1: "UI/UX Audit",
  ...
  return (
    <>
      <div
        ...
        } theme-bg-2 pt-150 pb-125 z-index-1`}
      >
              ...
              <div className="tp-service-3__right-wrap">
                {service_data.map((item, i) => (
                  <div
                    ...
                    style={{
                      background: "#5c785c",
                      boxShadow: "0px -8px 0px 0px rgb(36 57 27)",
                    }}
                  >
