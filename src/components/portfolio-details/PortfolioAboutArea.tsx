...
const portfolio_content = {
  ...
  description:
    "Booster is a B2B platform focused on increasing the revenues and overall efficiency of enterprises, whether big or small. The company offers trade analytics, consultations, and other commerce-related services to help businesses convert their visitors into leads.",
};
...
const PortfolioAboutArea = () => {
  return (
    <>
      <div
        id="porfolio-details"
        className="porfolio-details__info-wrap black-bg-3 pt-120 pb-100"
        style={{
          backgroundColor: "#213617",
        }}
      >
          ...
          <div className="row">
            <div className="col-xl-5 col-lg-4">
              <div className="porfolio-details__left-info">
                ...
                <div className="porfolio-details__left-content">
                  <h4 className="porfolio-details__left-info-title">
                    Role in project
                  </h4>
                  <span>UX/UI Design - branding</span>
                </div>
                <div className="porfolio-details__left-content">
                  <h4 className="porfolio-details__left-info-title mb-20">
                    Services
                  </h4>
                  <span>Branding</span>
            ...
            <div className="col-xl-7 col-lg-8">
              <div className="porfolio-details__right-info">
                <div className="porfolio-details__right-title-box">
                  <span className="tp-section-subtitle-4 mb-20">
                    {subtitle}
                  </span>
