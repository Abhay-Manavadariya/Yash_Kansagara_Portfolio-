...
const portfolio_detaisl_content: DataType = {
  title:
    "The technology that drives some of the best Platforms Out there is nothing without great planning",
  features: [
  ...
  images: [portfolio_img_1, portfolio_img_2, portfolio_img_3],
};
...
const PortfolioDetailsArea = () => {
  return (
    <>
      <div
        className="porfolio-details__overview-wrapper black-bg-3"
        style={{
                ...
                <div className="col-xl-7 col-lg-8">
                  <div className="porfolio-details__result-right">
                    {counter_data.map((item, index) => (
                      <div
                        className="porfolio-details__result d-flex align-items-end"
                        key={index}
                      >
