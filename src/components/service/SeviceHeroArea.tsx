...
const { subtitle, title, serrvice_list, slider_images_1, slider_images_2 } =
  hero_content;
...
const SeviceHeroArea = () => {
  return (
    <>
      <div className="sv-inner__slider-area theme-bg-2 sv-inner__slider-plr">
              ...
              <div className="sv-inner__slider-content-main d-flex justify-content-xl-end justify-content-start">
                <div className="sv-inner__slider-content-wrap">
                  <div className="sv-inner__slider-title-box">
                    <span className="sv-inner__slider-subtitle tp_title_anim">
                      {subtitle}
                    </span>
                    <h4 className="sv-inner__slider-title tp_title_anim">
                      {title}
                    </h4>
                  </div>
                  <div className="sv-inner__service-list-wrap">
                    {serrvice_list.map((item, index) => (
                      <div
                        key={index}
                        className={`sv-inner__service-list list-${item.id} wow tpfadeUp m-2`}
                ...
                <div className="row">
                  <div className="col-xl-6 col-lg-6 col-md-6">
                    <div className="sv-inner__slider-wrapper">
                      <Slider
                        {...setting_1}
                        className="sv-inner__slider-active-1"
                      >
                  ...
                  <div className="col-xl-6 col-lg-6 col-md-6">
                    <div className="sv-inner__slider-wrapper">
                      <Slider
                        {...setting_1}
                        className="sv-inner__slider-active-2"
                      >
