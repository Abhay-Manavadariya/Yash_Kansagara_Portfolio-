...
const contact_content: DataType = {
  ...
  mail_text: (
    <>
      Interested in working with me? Submit your <br /> project inquiry using
      the form below.
    </>
  ),
  categorys: [
...
const { subtitle, title_1, title_2, email, mail_text, categorys } =
  contact_content;
                ...
                <div className="col-xl-9 col-lg-10">
                  <div className="contact-inner__top-section-title-box mb-70">
                    ...
                    <h4 className="contact-inner__title tp-char-animation tp-hero-3__content">
                      {title_1}{" "}
                      {/* <span><Image src={contact_img} alt="image-here" /></span>  */}
                      <br />
                      {title_2}
                    </h4>
                  </div>
                    ...
                    {categorys.map((item, index) => (
                      <label
                        ...
                        className={`contact-category-btn ${
                          selectedCategories.includes(index) ? "active" : ""
                        }`}
                      >
                        {item.title}
                      </label>
